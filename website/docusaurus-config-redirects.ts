...
export const redirects = {
  ...
  redirects: [
    ...
    { from: '/develop/how-to-new-git', to: '/docs/developer' },
    ...
    { from: '/riscv-none-embed-gcc', to: 'https://xpack-dev-tools.github.io/riscv-none-embed-gcc-xpack/' },
    { from: '/riscv-none-embed-gcc/install', to: 'https://xpack-dev-tools.github.io/riscv-none-embed-gcc-xpack/docs/install/' },
    { from: '/riscv-none-embed-gcc/releases', to: 'https://xpack-dev-tools.github.io/riscv-none-embed-gcc-xpack/docs/releases/' },
    { from: '/riscv-none-embed-gcc/support', to: 'https://xpack-dev-tools.github.io/riscv-none-embed-gcc-xpack/docs/support' },
    ...
    { from: '/xpbuild', to: 'https://xpack-dev-tools.github.io/xpbuild/' },
    { from: '/xpbuild/cli', to: 'https://xpack-dev-tools.github.io/xpbuild/cli/' },
    { from: '/xpbuild/cli/ini', to: 'https://xpack-dev-tools.github.io/xpbuild/cli/init/' },
    { from: '/xpbuild/faq', to: 'https://xpack-dev-tools.github.io/xpbuild/faq/' },
    { from: '/xpbuild/install', to: 'https://xpack-dev-tools.github.io/xpbuild/install/' },
    { from: '/xpbuild/support', to: 'https://xpack-dev-tools.github.io/xpbuild/support/' },
    { from: '/xpcdl', to: 'https://xpack-dev-tools.github.io/xpcdl/' },
    { from: '/xpmake', to: 'https://xpack-dev-tools.github.io/xpmake/' },
    { from: '/xpninja', to: 'https://xpack-dev-tools.github.io/xpninja/' },
    { from: '/xsvd/files/xsvd-json', to: 'https://xpack-dev-tools.github.io/xsvd/files/xsvd-json/' },
